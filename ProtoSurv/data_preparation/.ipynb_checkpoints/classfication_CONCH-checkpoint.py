...
parser.add_argument('--data_h5_dir', type=str, default='./wsipatch/RESULTS_DIRECTORY')
parser.add_argument('--data_slide_dir', type=str, default='./svs/')
parser.add_argument('--slide_ext', type=str, default='.svs')
parser.add_argument('--csv_path', type=str, default='./wsipatch/RESULTS_DIRECTORY/process_list_autogen.csv')
parser.add_argument('--out_dir', type=str, default='./clas'
                                                   ''
                                                   ''
                                                   'sfication')
